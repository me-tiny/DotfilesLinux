#!/bin/bash
# Prints desktop-entry ids that should be hidden from the launcher: entries
# marked Hidden/NoDisplay, or excluded by OnlyShowIn/NotShowIn for the current
# desktop
#
# Usage: hidden-entries.sh "Hyprland:Hyprland"
